# -*- coding: utf-8 -*-
"""ListaExercicio3 (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_WsuUX86G9ru20ON2k8hS3y9TRJUw_EV
...
def valor_presente(fluxos, taxa):
    valor_presente = 0
    for t, valor in enumerate(fluxos, start=1):
        valor_presente += valor / ((1 + taxa) ** t)
...
for projeto in projetos:
    fluxos = df[projeto]
    vp = valor_presente(fluxos, taxa)
    st.write(f'Valor Presente de {projeto}: R${vp:.2f}')
